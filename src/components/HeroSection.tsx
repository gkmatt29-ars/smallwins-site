    ...
    <section className="pt-32 pb-20 md:pt-40 md:pb-28 relative overflow-hidden">
      ...
      <div className="container relative">
        <div className="max-w-3xl mx-auto text-center">
          {/* Tagline */}
          <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-accent/15 border border-accent/30 mb-5 opacity-0 animate-fade-in-up">
            <span className="text-sm font-semibold text-foreground">
              Approachable AI for Small Business
            </span>
          </div>

          {/* Headline */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground mb-5 opacity-0 animate-fade-in-up animation-delay-100">
            Collect requests.{" "}
            <span className="text-primary">Track work.</span>{" "}
